...
![GitHub tag (latest by date)](https://img.shields.io/github/tag-date/talsen-team/docker-app--kimai.svg?style=for-the-badge)
[![Docker Automated build](https://img.shields.io/docker/cloud/automated/talsenteam/docker-kimai.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-kimai/)
[![Docker Pulls](https://img.shields.io/docker/pulls/talsenteam/docker-kimai.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-kimai/)
[![Docker Build Status](https://img.shields.io/docker/cloud/build/talsenteam/docker-kimai.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-kimai/)
...
Any docker-compose--* tasks refer to the default dockerfile [kimai](docker/server--kimai/default.docker) and [kimai-database](docker/server--kimai-database/default.docker) as well as to the [docker-compose](docker-compose/server--kimai/default.docker-compose) configuration if required for command execution.
